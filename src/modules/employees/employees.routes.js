...
router.get('/me', verifyToken, employeeController.getMyEmployee);
router.get(
  '/operational-task-assignees',
  verifyToken,
  verifyModuleAccess('tasks', 'read'),
  employeeController.getOperationalTaskAssignees,
);
