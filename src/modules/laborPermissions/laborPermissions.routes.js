...
router.get(
  ...
  verifyToken,
  verifyModuleAccess('labor_permissions', 'create'),
  laborPermissionsController.getLaborPermissionCollaboratorCandidates
);
...
router.patch('/:id/status', verifyToken, verifyModuleAccess('labor_permissions', 'update'), laborPermissionsController.updateLaborPermissionStatus);
